...
public class ShootBallSequenceCommandSequence extends SequentialCommandGroup {
    public ShootBallSequenceCommandSequence(ShooterSubsystem shooterSubsystem, SpindexerSubsystem spindexerSubsystem, GateSubsystem gateSubsystem, IntakeSubsystem intakeSubsystem, RobotConstants.BallColors[] targetBallSequence) {
        addCommands(
                new InstantCommand(gateSubsystem::down),
                new WaitCommand(700),
                new ParallelCommandGroup(
                        new MoveSpindexerCommand(spindexerSubsystem, gateSubsystem, intakeSubsystem,1, true),
                        new WaitCommand(499)
                ),
                new ParallelCommandGroup(
                        new MoveSpindexerCommand(spindexerSubsystem, gateSubsystem, intakeSubsystem,1, true),
