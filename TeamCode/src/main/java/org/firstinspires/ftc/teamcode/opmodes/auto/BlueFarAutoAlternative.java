...
@Configurable
@Disabled
@Autonomous(name = "🔵 Far Alternative", group = "angryBirds", preselectTeleOp = "RedTeleOp")
public class BlueFarAutoAlternative extends CommandOpMode {
    ...
    public static class Paths {
        ...
        public static class Poses {
            public static final Pose LAUNCH = new Pose(144-89.4,18.5, Math.toRadians(180-64.5)); //DIFFERENT THAN RED
        ...
        public Paths(Follower follower) {
            ...
            intakeOverflow = follower
                    ...
                    .addPath(
                            new BezierCurve(
                                    Poses.LAUNCH,
                                    new Pose(144-144, 0).mirror(),
                                    new Pose(144-144, 0).mirror(),
                                    new Pose(144-130, 20).mirror(),
                                    new Pose(144-136.3,45).mirror()
                            )
                    )
                    .setTangentHeadingInterpolation()
                    .build();
            ...
            shootOverflow = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(new Pose(144-136.3,45).mirror(), Poses.LAUNCH)
                    )
            ...
            parkFar = follower
                    .pathBuilder()
                    .addPath(
                            new BezierLine(Poses.LAUNCH, new Pose(144-110, 8).mirror())
                    )
                    .setTangentHeadingInterpolation()
                    .build();
        }
