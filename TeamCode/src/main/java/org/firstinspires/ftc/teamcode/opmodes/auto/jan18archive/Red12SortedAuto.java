package org.firstinspires.ftc.teamcode.opmodes.auto.jan18archive;
...
@Config
@Autonomous(name = "Red 12ball sorted (old 1/18)", group = "angryBirds", preselectTeleOp = "Teleop")
public class Red12SortedAuto extends CommandOpMode {
    //paths
    ...
    public static Pose startingPose = new Pose(122.361,121.175,Math.toRadians(50)); //find actual statring pos
    ...
    public void buildPaths(Follower follower) {
        ...
        paths.add(follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(122.361, 121.175), new Pose(91, 82))
                )
        ...
        paths.add(follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(91, 82), new Pose(96, 82.000))
                )
        ...
        paths.add(follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(96, 82.000), new Pose(117, 82.000))
                )
        ...
        paths.add(follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(115.000, 55), new Pose(91, 82))
                )
        ...
        paths.add(follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(91, 82), new Pose(91, 31))
                )
                .setLinearHeadingInterpolation(Math.toRadians(50), Math.toRadians(0))
                .build()
        );
        ...
        paths.add(follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(125, 31), new Pose(91, 82))
                )
                .setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(50))
                .build()
        );
        ...
        paths.add(follower
                .pathBuilder()
                .addPath(
                        new BezierLine(new Pose(91, 82), new Pose(99, 78))
                )
                .setLinearHeadingInterpolation(Math.toRadians(50), Math.toRadians(50))
                .build()
        );
...
//                                        new WaitForRobotStuckCommand(follower),
    ...
    public void run() {
        ...
        telemetry.addData("shooter target ticks", shooter.getTargetTicks());
        telemetry.addData("shooter actual ticks", shooter.getVelocityTicks());
