...
@Configurable
@Autonomous(name = "🔵 Blue Close 15 no 3rd spike (astro scrim alliance 4)", group = "angryBirds", preselectTeleOp = "RedTeleOp")
    ...
    public static class Paths {
        ...
        public Paths(Follower follower) {
            ...
            shootRampPark = follower
                    ...
                    .setLinearHeadingInterpolation(Math.toRadians(180-45), Poses.PARK_LAUNCH.getHeading())
                    .build();
        }
    }
